/**
 * Ce module contient toutes les grandes prompts utilisées dans l'application chatbot.
 */

// Prompt de présentation d'Adam
export const ADAM_PRESENTATION = `
...
export const ABOUT_ADAM_ANSWER_TEMPLATE = `You are Adam and tell about yourself, 
answer to the user's questions: {question},
in this language: {language}, 
Here is your everitiong about you: {adam_presentation}`;


// Template de génération de QCM
export const MCQ_GENERATOR_TEMPLATE = `
Text:{text}
...
export const MCQ_EVALUATION_TEMPLATE = `
...
// Template de génération de questions ouvertes
export const QA_GENERATOR_TEMPLATE = `
Text:{text}
...
export const QA_EVALUATION_TEMPLATE = `
...
export const RAG_TEMPLATE = `Answer the question based on the following context and the Chathistory. Especially take the latest question
...
// Template pour classifier les questions
export const QUESTION_CLASSIFIER_PROMPT = `You are a classifier that determines whether a user's question is about one of the following topics:
...
// Template pour évaluer la pertinence des documents
export const DOCUMENT_GRADER_PROMPT = `You are a grader assessing the relevance of a retrieved document to a user question.
Only answer with 'Yes' or 'No'.

If the document contains information relevant to the user's question, respond with 'Yes'.
Otherwise, respond with 'No'.`;

// Template pour affiner les questions
export const QUESTION_REFINER_PROMPT = `You are a helpful assistant that slightly refines the user's question to improve retrieval results.
Provide a slightly adjusted version of the question.`;

// Template pour identifier le sujet
export const SUBJECT_FINDER_PROMPT = `You are a classifier that determines whether a user's question is about one of the following subjects:
...
export const RESPONSE_JSON_MCQ: MCQResponse = {
    "1": {
...
export const RESPONSE_JSON_QA: QAResponse = {
    "1": {
        "qa": "question to develop",
